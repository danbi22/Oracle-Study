/*
DML (Date Manipulation Language): 데이터 조작 언어. insert, update, delete. [select]
...
update my_emp1
set job = 'MANAGER', hiredate = TO_DATE('2000/12/13'), deptno = 40
where empno = 1004;
...
select * from my_emp1 where deptno = 10;
